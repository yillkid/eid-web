function eIDLogin(id_token, res) {
  console.log("hello, e-mail = " + res.result.emailAddresses[0].value);
  console.log("hello, username = " + res.result.names[0].displayName);

  console.log("hello, token = " +  id_token);
//  console.log("hello, access_token = " +  res.data.access);
//  console.log("hello, refresh_token = " + res.data.refresh);
}
